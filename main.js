...
function openNav() {
    if(nav == false && window.innerWidth >= 1200) {
    ...
    else if(nav == false && window.innerWidth < 1200)
    {
...
window.onload =  function kolor(){
    document.getElementById('kolor').style.color = "brown";
    document.getElementById('kolor').style.fontSize = "38px";
};